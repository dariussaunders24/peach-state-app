...
const defaultDisclaimer =
  "By RSVP’ing to or participating in this event, you acknowledge that off-road driving, overlanding, and recovery activities involve inherent risks, including vehicle/property damage, personal injury, and recovery expenses. You voluntarily accept these risks and are responsible for your vehicle, passengers, equipment, actions, and determining whether you and your vehicle are capable of participating. Peach State Off-Road and Overlanding, its owners, administrators, ride captains, volunteers, organizers, sponsors, and event hosts are not responsible for injury, damage, loss, recovery costs, or other liability resulting from participation. Recovery assistance is not guaranteed. Alcohol or any substance that may impair a driver is prohibited before or during trail or off-road driving activities. Anyone believed to be impaired or acting unsafely may be asked to leave. No-shows who do not cancel at least 24 hours before a trail ride may receive a one-ride suspension from future PSO trail rides. By RSVP’ing, you acknowledge and agree to these terms.";
