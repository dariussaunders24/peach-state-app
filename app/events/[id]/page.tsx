...
const defaultDisclaimer =
  "By RSVP’ing to and/or participating in this event, you acknowledge that off-road driving, overlanding, recovery operations, and related activities involve inherent risks. You voluntarily accept all risks associated with participation, including vehicle damage, property damage, personal injury, recovery expenses, and other losses. You are responsible for your own vehicle, passengers, equipment, actions, and decisions. Peach State Off-Road and Overlanding, its owners, administrators, ride captains, volunteers, organizers, sponsors, and event hosts are not responsible for damage, injury, loss, recovery costs, or other liability resulting from participation in this event. Drivers are responsible for determining whether their vehicle and their own experience are appropriate for the event. Participation is always at your own risk, and assistance or vehicle recovery cannot be guaranteed. Alcohol consumption and the use of any substance that may impair a driver are prohibited before or during any PSO trail ride or off-road driving activity. Anyone believed to be impaired or behaving in an unsafe manner may be asked to leave the event. No-shows who fail to cancel their RSVP at least 24 hours before a trail ride may receive a one-ride suspension from future PSO trail rides. This policy helps keep limited event spaces available to members who are able to attend. By RSVP’ing, you confirm that you have read, understand, and agree to these terms.";
